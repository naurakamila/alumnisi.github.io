						...
						'settings' => [
							'woo-builder-friendly' => [
							  'name' => __('Builder friendly products.', 'peepso-theme-gecko'),
								'desc' => __('Makes every single product view builder friendly.', 'peepso-theme-gecko'),
							...
							'woo-sidebars-vis' => [
							  'name' => __('Show sidebars on Product pages.', 'peepso-theme-gecko'),
							  'id' => 'woo-sidebars-vis',
							  'type' => 'switch',
							...
							'woo-mobile-single-col' => [
							  'name' => __('Force single column view on Mobile.', 'peepso-theme-gecko'),
