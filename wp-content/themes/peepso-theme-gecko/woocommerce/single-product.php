...
if (1 == $gecko_settings->get_option( 'opt_woo_builder', 0 )) {
...
<div id="main" class="main main--single <?php echo $main_class; if ($full_width_layout == 1) : echo " main--full"; endif; if ($builder_friendly_layout == 1) : echo " main--builder"; endif; ?>">
	...
	<?php if (1 == $gecko_settings->get_option( 'opt_woo_sidebars', 1 )) { get_sidebar('left'); } ?>
	...
	<?php if (1 == $gecko_settings->get_option( 'opt_woo_sidebars', 1 )) { get_sidebar('right'); } ?>
</div>
